...
public class PopDualListView extends LinearLayout implements ViewBaseAction {
    private static String TAG = PopDualListView.class.getSimpleName();
	...
	private String showString = "按区域";

	public PopDualListView(Context context) {
		super(context);
		init(context);
	}

	public PopDualListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		inflater.inflate(R.layout.pw_view_region, this, true);
